package com.isradlabs.sms.applicationform.model.domain.students;
...
@AllArgsConstructor
@Entity
@Table(name = "t_application_form_parent_qualification")
public class StudentRelationQualification extends BaseDomain {
